...
public abstract class AbstractSearchTree<E extends Comparable<? super E>> implements Iterable<E> {
    ...
    protected class Node {
        ...
        /**
         * Nastaví uzol ako lavého syna a ak syn nieje null, nastaví mu ako parenta aktualny uzol
         * @param paNode 
         */
        ...
        /**
         * Nastaví uzol ako pravého syna a ak syn nieje null, nastaví mu ako parenta aktualny uzol
         * @param paNode 
         */
    ...
    /**
     * Metoda prehľadá strom<br>
     * do atribútu aLastUsedNode nastaví posledný použitý uzol v prehľadávani<br>
     * null - ak je strom prázdny
     * rovnaký prvok ako hľadaný ak sa nejaký našiel
     * @param params
     * @return Null, ak je strom prázdny alebo sa uzol v strome nenachadza<br>hľadaný uzol, ak ho našlo
     */
